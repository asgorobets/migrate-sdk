...
Simplify the Commercetools destination API so migration code can pass Commercetools SDK drafts and typed update actions directly to destination helpers.
