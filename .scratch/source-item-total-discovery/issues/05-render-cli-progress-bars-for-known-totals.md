...
- [x] `--progress none` avoids total discovery unless another explicit progress consumer requests it.
...
- CLI log and interactive progress providers now opt in to Source Item total discovery.
...
- `--progress none` remains discovery-free.
