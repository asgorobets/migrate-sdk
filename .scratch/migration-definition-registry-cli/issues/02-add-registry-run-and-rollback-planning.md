...
- [ ] Optional dependency cycles degrade the whole plan to required-dependency ordering, preserve deterministic registry order for optional relationships, and surface notices instead of failing.
...
- [ ] Rollback target planning rejects required dependency expansion until cross-definition target identity mapping is designed.
...
- [ ] Registry rollback helpers preserve lower-level dependent rollback safety by passing the full registry graph and selected definition ids into runtime preflight.
