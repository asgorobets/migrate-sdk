...
export const CatalogBookDisposition = Schema.Literals([
  "fail-reference",
  "invalid",
  "migrate",
  "skip",
...
export type CatalogBookRow = typeof CatalogBookSourceRow.Type;
